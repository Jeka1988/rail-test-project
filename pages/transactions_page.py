...
class TransactionsPage(BasePage):
    ...
    def __init__(self, page: Page, base_url: str) -> None:
        ...
        self.transaction_entries = page.locator(
            '[data-testid="all-txn-row"][data-type="debit"]'
        )
        self.transaction_amounts = page.get_by_test_id("all-txn-amount")

    def transaction_row(self, description: str) -> Locator:
        """Debit transaction row matching the description."""
        return self.transaction_entries.filter(has_text=description)

    def transaction_amount(self, description: str, amount: str) -> Locator:
        """Amount cell within a matching debit transaction row."""
    ...
    def open_transactions(self) -> None:
        """Open the transactions page and wait for it to be ready."""
        self.open()
