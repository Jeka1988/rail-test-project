...
class BillPayPage(BasePage):
    ...
    def __init__(self, page: Page, base_url: str) -> None:
        ...
        self.bill_pay_form = page.get_by_test_id("bill-pay-form")
        ...
        self.biller_reference_input = page.locator("input[name='biller_ref_field']")
    ...
    def biller_result(self, biller_name: str) -> Locator:
        option = self.visible_option(biller_name)
        if option.count() > 0:
            return option
        return self.page.get_by_text(biller_name, exact=False)
    ...
    def _ensure_biller(self, bill_data: dict[str, Any]) -> None:
        ...
        self.biller_result(biller_name).first.click()
